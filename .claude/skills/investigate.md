---
description: /project:investigate — Structured debugging. No fixes without root cause.
---
...
7. **Log** — record in `.claude/memory/progress.md` Known Issues. Remove when resolved.
