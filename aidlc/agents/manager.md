...
Role: orchestrator. New initiatives, cross-concern coordination, daily reports.
...
(In Claude Code these are slash commands `/project:spec` etc; in Codex/Cursor they're phase prompts loaded from `aidlc/{phase}/`.)
...
## Daily Report
Gather: `git log --since="24 hours ago"`, branches, `memory/progress.md` (or tool-specific equivalent), `docs/adr/`, test health.
