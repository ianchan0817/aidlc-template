...
3. **Task breakdown** — atomic tasks, S/M/L estimates, test tasks, dependencies, risks. List each conditional phase (design, eval, security, e2e) as **run/skip with a one-line rationale** — reviewer may challenge skips at the gate. Definition of done: 100% coverage, reviewed, E2E signed off, evals green if AI features.
