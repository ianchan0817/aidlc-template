...
Review the diff against the sprint contract and the verification evidence. Never accept self-reported completion without tests, runtime proof or eval transcripts. Every finding names the observable outcome that fails.
