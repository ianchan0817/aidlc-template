...
3. **Handoff** — every screen state described, component inventory, responsive notes, edge cases (long names, empty, slow). Update `aidlc/rules/ux-guidelines.md` if new patterns.
